...
const formatDoc = (d) => {
  ...
  return {
    id: d.id,
    ...data,
    category: data.category || "Workflow Automation",
      ...
      <CardFooter className="p-6 md:p-8 pt-0 flex flex-col sm:flex-row gap-3">
        ...
        >
          <Link href={project.liveUrl || "#"} target="_blank">
            View Platform <ExternalLink className="ml-2 h-3.5 w-3.5" />
          </Link>
        </Button>
...
export default function AIAutomationDevelopmentService({
  ...
  useVisitorTracker("Service: AI Automation");
  ...
  useEffect(() => {
    const unsubscribe = subscribeToaiautomationProjects((updated) => {
      setProjects(updated);
      setLoading(false);
    });
    return unsubscribe;
  ...
  const handleFormSubmit = async (data) => {
    ...
    try {
      if (editingProject) {
        await updateaiautomationProject(editingProject.id, data);
  ...
  const confirmDelete = async () => {
    try {
      await deleteaiautomationProject(projectToDeleteId);
      ...
      >
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="mt-5 text-base md:text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed">
            We build intelligent AI workflows, autonomous agents, and custom
            tools designed to automate repetitive tasks and eliminate
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 gap-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm md:text-base mt-1">
                Here&apos;s a showcase of intelligent automation systems we have
            ...
            {isAdmin && (
              <Button
                ...
                aria-label="Add a new AI automation project"
              >
      ...
      >
        <AlertDialogContent className="rounded-2xl border-border">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action will permanently delete this AI automation project

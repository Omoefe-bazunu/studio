...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background px-6 py-24 relative overflow-hidden">
      ...
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl h-96 bg-[#FF8C38]/10 blur-[130px] pointer-events-none"
        aria-hidden="true"
      />
      <div
      ...
      <div className="w-full max-w-md bg-card/90 backdrop-blur-md border border-border/80 p-8 md:p-10 rounded-2xl shadow-xl relative z-10">
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-primary/[0.08] border border-primary/20 mb-3">
            <Sparkles className="w-3.5 h-3.5 text-primary" />
            <span className="font-sans text-xs font-bold tracking-wider uppercase text-primary">
              Get Started Free
            </span>
          </div>
        ...
        {error && (
          <div className="mb-6 p-3.5 rounded-xl bg-destructive/10 border border-destructive/20 flex items-start gap-3 animate-in fade-in slide-in-from-top-2">

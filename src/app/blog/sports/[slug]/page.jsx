...
export default function SportsBlogPostPage() {
  ...
  const fetchPost = React.useCallback(async () => {
    ...
    try {
      ...
      setFetchError(
        "Critical Error: Unable to resolve article from the Sports stack.",
      );
    } finally {
      setIsLoading(false);
    }
    ...
    <main className="bg-white dark:bg-slate-900 dark:text-white min-h-screen pb-24">
      ...
      <div className="bg-slate-50 dark:bg-slate-900 dark:border-slate-600 border-b border-slate-100 py-4 mb-12">
        <div className="max-w-4xl mx-auto px-6 flex justify-between items-center">
          ...
          >
            <ChevronLeft size={14} /> Back to Sports Posts
          </Link>

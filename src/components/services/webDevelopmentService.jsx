...
export default function WebDevelopmentService({ initialProjectsData = [] }) {
  ...
  return (
    <div className="flex flex-col">
      {/* 1. HERO SECTION */}
      <section className="relative w-full py-24 bg-[#0F0A1F] overflow-hidden">
        <div
        ...
        <div className="container relative z-10 mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-purple-200 text-sm mb-8">
            <Laptop className="w-4 h-4 text-[#FF8C38]" />{" "}
          ...
          <div className="mt-12">
            ...
            >
              <Link href={whatsappLink} target="_blank">
                Inquire via WhatsApp <MessageCircle className="ml-2 h-6 w-6" />
              </Link>
            </Button>
          </div>
        </div>
